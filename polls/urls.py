...
from polls.views import ListSubmittedPolls, ListAllPolls, RetrievePoll, \
    RetrievePollForDate, SubmitPoll, UpdatePoll, PollResults, CreateVote
...
urlpatterns = [
    ...
    path('<int:year>/<int:month>/<int:day>/', RetrievePollForDate.as_view(), name='poll-retrieve-for-date'),
