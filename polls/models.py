...
class Poll(models.Model):
    ...
    state = models.CharField(
        verbose_name="état", max_length=9, choices=STATES, default="REVIEWING"
    )

    # The date of publication.
    publication_date = models.DateField(
        verbose_name="date de publication", null=True, default=None
    )
    ...
    def is_active(self):
        return (
            ...
            and self.publication_date + self.POLL_LIFETIME > date.today()
        )
...
class Choice(models.Model):
    ...
    text = models.CharField(verbose_name="texte du choix", max_length=200)

    # The related poll.
    poll = models.ForeignKey(
        Poll, verbose_name="sondage", on_delete=models.CASCADE, related_name="choices"
    )
...
class Vote(models.Model):
    # The related poll
    poll = models.ForeignKey(
        Poll, verbose_name="sondage", on_delete=models.CASCADE, related_name="votes"
    )
