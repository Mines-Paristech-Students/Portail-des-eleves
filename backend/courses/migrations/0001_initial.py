# Generated by Django 2.2.10 on 2020-04-29 02:36
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('form', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='question', to='courses.Form')),
            ],
        ),
        migrations.CreateModel(
            name='Rating',
        ...
        migrations.AddField(
            model_name='course',
            name='form',
            field=models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.CASCADE, related_name='course', to='courses.Form'),
        ),
        migrations.AddField(
            model_name='course',
            name='have_voted',
