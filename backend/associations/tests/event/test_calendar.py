...
class CalendarTestCase(BaseEventsTestCase):
    ...
    def setUp(self):
        ...
        self.event_starts_one_week_after_little = turn_little(
            event_starts_one_week_after
        )
        ...
        self.event_ends_one_week_before_little = turn_little(event_ends_one_week_before)

        # Event.objects.create(**event_starts_two_weeks_after)
        Event.objects.create(**event_starts_one_week_after)
        Event.objects.create(**event_ends_one_week_before)
