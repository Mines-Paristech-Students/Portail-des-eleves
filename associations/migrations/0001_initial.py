# Generated by Django 2.0.7 on 2019-02-18 07:53
    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('description', models.TextField()),
                ('file', models.FileField(storage=django.core.files.storage.FileSystemStorage(location='/medias/uploads/associations'), upload_to='', verbose_name=associations.models.association.Association)),
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('name', models.CharField(max_length=250)),
                ('association', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='associations.Association')),
                ('parent', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, related_name='children', to='associations.Folder')),
            ],
        ),
        migrations.CreateModel(
            name='Funding',
