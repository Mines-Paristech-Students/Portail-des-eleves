...
from associations.views import (
    ...
    LoanableViewSet,
    RoleViewSet,
    NewsAssociationViewSet,
    NewsSubscriptionsView,
)
...
associations_router = routers.NestedSimpleRouter(
    router, r"associations", lookup="association"
)
