...
ALL_USERS = ['17simple', '17admin', '17admin_biero', '17member_biero', '17admin_pdm', '17member_pdm']
...
class BaseRoleTestCase(BaseTestCase):
    ...
    SERIALIZED_FIELDS = (('id', 'user', 'association', 'role', 'rank', 'is_archived') +
    ...
    ASSOCIATION_ADMIN_ALLOWED_FIELDS = (('user', 'association', 'is_archived', 'role', 'rank') +
                                        tuple(f'{permission_name}_permission' for permission_name in
                                              Role.PERMISSION_NAMES))
